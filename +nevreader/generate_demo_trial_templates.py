...
def main():
    ...
    _3ec_edge_cal['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 192, 'missable': False})
    _3ec_edge_cal['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 255, 'missable': True})
    ...
    _3ec_edge_or['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 198, 'missable': False})
    _3ec_edge_or['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 255, 'missable': True})
    ...
    _3ec_edge_or0['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 198, 'missable': False})
    _3ec_edge_or0['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 255, 'missable': True})
    ...
    _3ec_edge_pos['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 199, 'missable': False})
    _3ec_edge_pos['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 255, 'missable': True})
    ...
    _3ec_gratings['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 192, 'missable': False})
    _3ec_gratings['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 207, 'missable': True})
    ...
    _3ec_images['codes'].insert(5, {'type': 'RANGE', 'min_value': 192, 'max_value': 192, 'missable': False})
    _3ec_images['codes'].insert(6, {'type': 'RANGE', 'min_value': 192, 'max_value': 208, 'missable': True})
    ...
    write_json(contrast, 'contrast.json')
